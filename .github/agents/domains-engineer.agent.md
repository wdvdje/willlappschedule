---
description: "Domains Subteam Engineer for TimeScape native macOS app. Use when: implementing approved SwiftUI changes to Personal, Household, or Professional domain views; running Xcode build checks on DomainViews; fixing compile errors in domain view files."
...
- Implement SwiftUI changes as approved by the Domains Lead and/or Designer
