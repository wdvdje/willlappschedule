...
#ifndef TIMESCAPE_PLANNER_PRO_SWIFT_H
#define TIMESCAPE_PLANNER_PRO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TimeScape_Planner_Pro",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21TimeScape_Planner_Pro25LocationAutocompleteModel")
@interface LocationAutocompleteModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class MKLocalSearchCompleter;
@interface LocationAutocompleteModel (SWIFT_EXTENSION(TimeScape_Planner_Pro)) <MKLocalSearchCompleterDelegate>
