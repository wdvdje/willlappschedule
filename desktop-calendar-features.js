...
(function () {
  ...
  (function injectTransitionCSS() {
    ...
    style.textContent = [
      ...
      '.dcf-layer-bar { display:flex;gap:5px;flex-wrap:wrap;align-items:center;max-width:100%;margin:0 auto 6px;padding:0 24px;box-sizing:border-box; }',
      ...
      '.dcf-year-grid { display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:14px;padding:10px 24px;max-width:100%;margin:0 auto; }',
      ...
      '  #calPageLayout { display:flex;gap:10px;align-items:flex-start;max-width:100%;padding:0 12px;box-sizing:border-box; }',
      '  #calCenterPanel { flex:1;min-width:0; }',
      '  .cal-side-panel { display:block;width:230px;flex-shrink:0;background:#fff;border-radius:12px;',
